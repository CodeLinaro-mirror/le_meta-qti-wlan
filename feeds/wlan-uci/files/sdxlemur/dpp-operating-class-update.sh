	...
	then
		case "$htmode" in
			*HT20)
			...
			;;
			*HT40)
				if [ $channel -eq 3 -o $channel -eq 11 -o $channel -eq 19 -o $channel -eq 27 -o $channel -eq 35 -o $channel -eq 43 -o $channel -eq 51 -o $channel -eq 59 -o $channel -eq 67 -o $channel -eq 75 -o $channel -eq 83 -o $channel -eq 91 -o $channel -eq 99 ]
				then
					return 132
				elif [ $channel -eq 107 -o $channel -eq 115 -o $channel -eq 123 -o $channel -eq 131 -o $channel -eq 139 -o $channel -eq 147 -o $channel -eq 155 -o $channel -eq 163 -o $channel -eq 171 -o $channel -eq 179 -o $channel -eq 187 -o $channel -eq 195 ]
				then
					return 132
				elif [ $channel -eq 203 -o $channel -eq 211 -o $channel -eq 219 -o $channel -eq 227 ]
				then
					return 132
				else
					echo "Invalid HTMODE to the configured channel" > /dev/console
			...
			;;
			*HT80)
				if [ $channel -eq 7 -o $channel -eq 23 -o $channel -eq 39 -o $channel -eq 55 -o $channel -eq 71 -o $channel -eq 87 -o $channel -eq 103 -o $channel -eq 119 -o $channel -eq 135 -o $channel -eq 151 -o $channel -eq 167 -o $channel -eq 183 -o $channel -eq 199 -o $channel -eq 215 ]
				then
					return 133
				else
					echo "Invalid HTMODE to the configured channel" > /dev/console
			...
			;;
			*HT160)
				if [ $channel -eq 15 -o $channel -eq 47 -o $channel -eq 79 -o $channel -eq 111 -o $channel -eq 143 -o $channel -eq 175 -o $channel -eq 207 ]
				then
					return 134
				else
					echo "Invalid HTMODE to the configured channel" > /dev/console
