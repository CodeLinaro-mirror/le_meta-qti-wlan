...
EXTRA_OECONF += "${@oe.utils.conditional('BASEMACHINE', 'qcs40x', '--enable-target-qcs405-som1=yes', '', d)}"
EXTRA_OECONF += "${@oe.utils.conditional('BASEMACHINE', 'qcs605', '--enable-target-qcs605=yes', '', d)}"
EXTRA_OECONF += "${@oe.utils.conditional('BASEMACHINE', 'sdm845', '--enable-target-sdm845=yes', '', d)}"
EXTRA_OECONF += "${@oe.utils.conditional('BASEMACHINE', 'sdmsteppe', '--enable-target-sdmsteppe=yes', '', d)}"
