...
SRC_URI:append:qcm4325-mtp+= "file://neo/wlan_daemon.service"
SRC_URI:append:qcm4325-mtp+= "file://neo/wlan-conf_systemd_tmpfiles.conf"
...
EXTRA_OECONF += "${@bb.utils.contains('BASEMACHINE', 'qcm4325-mtp', '--enable-target-qcm4325-mtp=yes', '', d)}"
