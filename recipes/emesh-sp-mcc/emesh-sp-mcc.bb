...
DESCRIPTION = "Recipe file for the MCC kernel module for Service Prioritization in EasyMesh"
LICENSE = "ISC"
LIC_FILES_CHKSUM = "file://${TOPDIR}/../poky/meta/files/common-licenses/ISC;md5=f3b90e78ea0cffb20bf5cca7947a896d"

S = "${WORKDIR}/wlan/ezmesh-r6/emesh-sp"

FILESPATH =+ "${TOPDIR}/../src:"

DEPENDS = "glib-2.0 virtual/kernel"

SRC_URI = "file://wlan/ezmesh-r6/emesh-sp"
...
do_install() {
	install -d ${D}/usr/include/emesh-sp_mcc
	install -m 0644 ${S}/sp_api.h ${D}/usr/include/emesh-sp_mcc
	mkdir -p ${STAGING_DIR}/usr/include/emesh-sp_mcc
	cp ${TOPDIR}/../src/wlan/ezmesh-r6/emesh-sp/*.h ${STAGING_DIR}/usr/include/emesh-sp_mcc

	install -d ${D}${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra
	install -m 0755 ${S}/*.ko ${D}/${nonarch_base_libdir}/modules/${KERNEL_VERSION}/extra/
	install -m 0755 ${S}/Module.symvers ${STAGING_DIR}/usr/include/emesh-sp_mcc/
	install -d ${D}${base_libdir}/modules/${KERNEL_VERSION}/kernel/drivers/${PN}
	install -m 0755 ${S}/*.ko ${D}${base_libdir}/modules/${KERNEL_VERSION}/kernel/drivers/${PN}

	install -d ${D}/etc/initscripts
	install -m 0755 ${THISDIR}/files/emesh-sp.initscripts ${D}/etc/initscripts/start_emesh-sp-mcc
}
