...
FIRMWARE_PATH_COLOGNE = "${D}${nonarch_base_libdir}/firmware/wlan/qca_cld/wcn7760"
...
do_install:append:sa410m(){
	...
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx24_auto/WCNSS_qcom_cfg_qca6174.ini ${FIRMWARE_PATH_ROME}/WCNSS_qcom_cfg.ini
...
do_install:append:sa525m(){
	...
	install -d ${FIRMWARE_PATH_COLOGNE}
	install -d ${D}/data/qca6574
	install -d ${D}/data/qca6490
	install -d ${D}/data/qca6797
	install -d ${D}/data/wcn7760
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx_auto/WCNSS_qcom_cfg_qca6174.ini ${D}/data/qca6574/WCNSS_qcom_cfg.ini
	chmod -R 0664 ${D}/data/qca6574/WCNSS_qcom_cfg.ini
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx_auto/WCNSS_qcom_cfg_qca6490.ini ${D}/data/qca6490/WCNSS_qcom_cfg.ini
	chmod -R 0664 ${D}/data/qca6490/WCNSS_qcom_cfg.ini
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx_auto/WCNSS_qcom_cfg_qca6797.ini ${D}/data/qca6797/WCNSS_qcom_cfg.ini
        chmod -R 0664 ${D}/data/qca6797/WCNSS_qcom_cfg.ini
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx_auto/WCNSS_qcom_cfg_wcn7760.ini ${D}/data/wcn7760/WCNSS_qcom_cfg.ini
        chmod -R 0664 ${D}/data/wcn7760/WCNSS_qcom_cfg.ini
        ...
        ln -sf /data/wcn7760/WCNSS_qcom_cfg.ini ${FIRMWARE_PATH_COLOGNE}/
}
...
do_install:append:sa515m(){
	...
	install -D -m 0644 ${UNPACKDIR}/device/qcom/wlan/sdx_auto/WCNSS_qcom_cfg_qca6490.ini ${FIRMWARE_PATH}/WCNSS_qcom_cfg.ini
