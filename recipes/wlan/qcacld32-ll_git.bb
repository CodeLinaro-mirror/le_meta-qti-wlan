...
EXTRA_OEMAKE += "CONFIG_CLD_HL_SDIO_CORE=n CONFIG_CNSS_SDIO=n CONFIG_WLAN_SYNC_TSF_PLUS=y CONFIG_WLAN_SYNC_TSF_TIMER=y CONFIG_WLAN_TWT_SAP_STA_COUNT=2 CONFIG_WLAN_TWT_SAP_PDEV_COUNT=y"
