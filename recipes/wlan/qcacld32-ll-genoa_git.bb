...
EXTRA_OEMAKE_append_sdxprairie = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_WDI2_IPA_OVER_GSI=y CONFIG_WLAN_MAX_VDEVS=4 CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_GET_DRIVER_MODE=y CONFIG_LTE_COEX=y CONFIG_QCOM_LTE_COEX=y CONFIG_FEATURE_COEX=y CONFIG_QCACLD_FEATURE_BTC_CHAIN_MODE=y CONFIG_QCACLD_FEATURE_COEX_CONFIG=y CONFIG_FW_THERMAL_THROTTLE=y  CONFIG_WLAN_CFR_ENABLE=y CONFIG_WLAN_CFR_ADRASTEA=y CONFIG_WLAN_STREAMFS=y CONFIG_WLAN_FULL_POWER_DOWN=y CONFIG_WLAN_CE4_SZ_QCN7605=2048 CONFIG_SIR_SAP_MAX_NUM_PEERS=32""
EXTRA_OEMAKE_append_sa415m = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_WLAN_MAX_VDEVS=4 CONFIG_WLAN_ICMP_REQ_DETECT=y CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_WDI2_IPA_OVER_GSI=y CONFIG_LTE_COEX=y CONFIG_QCOM_LTE_COEX=y CONFIG_WLAN_FEATURE_WOW_PULSE=y CONFIG_GET_DRIVER_MODE=y CONFIG_WLAN_CE4_SZ_QCN7605=4096 CONFIG_SIR_SAP_MAX_NUM_PEERS=32""
