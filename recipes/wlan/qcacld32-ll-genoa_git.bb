...
EXTRA_OEMAKE_append_sa415m = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_WLAN_MAX_VDEVS=4 CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_WDI2_IPA_OVER_GSI=y CONFIG_LTE_COEX=y CONFIG_QCOM_LTE_COEX=y CONFIG_WLAN_FEATURE_WOW_PULSE=y CONFIG_GET_DRIVER_MODE=y""
