...
EXTRA_OEMAKE_append_sdxprairie = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_WDI2_IPA_OVER_GSI=y CONFIG_WLAN_MAX_VDEVS=4 CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_LIMIT_IPA_TX_BUFFER=1500""
EXTRA_OEMAKE_append_sa415m = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_WLAN_MAX_VDEVS=4 CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_IPA_OFFLOAD=n CONFIG_GET_DRIVER_MODE=y""
