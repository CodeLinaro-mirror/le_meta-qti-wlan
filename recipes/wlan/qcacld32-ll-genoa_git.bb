...
EXTRA_OEMAKE_append_sdxprairie = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_NAPI=n CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_WDI2_IPA_OVER_GSI=y CONFIG_WLAN_MAX_VDEVS=4 CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_LIMIT_IPA_TX_BUFFER=1500 CONFIG_GET_DRIVER_MODE=y CONFIG_LTE_COEX=y CONFIG_QCOM_LTE_COEX=y""
