...
FILES_${PN}     += "lib/modules/${KERNEL_VERSION}/extra/wlan_debug.ko"
...
EXTRA_OEMAKE += "CONFIG_CNSS=n CONFIG_CLD_HL_SDIO_CORE=n CONFIG_CNSS_SDIO=n CONFIG_CNSS2=n CONFIG_WLAN_DISABLE_EXPORT_SYMBOL=y"
