...
EXTRA_OEMAKE_append_sa515m = " WLAN_CFG_OVERRIDE="CONFIG_IPA_OFFLOAD=n CONFIG_WLAN_CONV_SPECTRAL_ENABLE=n CONFIG_WLAN_WBUFF=n CONFIG_REMOVE_PKT_LOG=y CONFIG_WDI_EVENT_ENABLE=n""
