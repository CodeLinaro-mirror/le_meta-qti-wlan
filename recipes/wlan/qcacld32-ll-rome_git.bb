...
EXTRA_OEMAKE_append_sa515m = " WLAN_CFG_OVERRIDE="CONFIG_WLAN_CONV_SPECTRAL_ENABLE=n CONFIG_WLAN_WBUFF=n CONFIG_REMOVE_PKT_LOG=y CONFIG_WDI_EVENT_ENABLE=n CONFIG_NUM_IPA_IFACE=2 CONFIG_ENABLE_SMMU_S1_TRANSLATION=y CONFIG_FEATURE_IPA_PIPE_CHANGE_WDI1=y CONFIG_MDM_PLATFORM=y""
