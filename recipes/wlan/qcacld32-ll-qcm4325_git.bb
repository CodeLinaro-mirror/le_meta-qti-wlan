...
KERNEL_DEFCONFIG ?= "bengal_le_GKI.config"
KERNEL_DEFCONFIG_qti-distro-debug ?= "bengal_le-gki_defconfig"
...
WLAN_CONFIG = "qcm4325.snoc.perf"

KERNEL_VERSION = "${@get_kernelversion_file("${STAGING_KERNEL_BUILDDIR}")}"
EXT_MODULES = "${@os.path.relpath("${S}", "${KERNEL_PLATFORM_PATH}")}"

ADDITIONAL_CONFIGS = ""
ADDITIONAL_CONFIGS:append:qcm4325-mtp = " CONFIG_CP_STATS=y "
