...
EXTRA_OEMAKE_append_sdxprairie = " WLAN_CFG_OVERRIDE="CONFIG_FEATURE_WLAN_STA_AP_MODE_DFS_DISABLE=n CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_DCS=n CONFIG_WLAN_FEATURE_MIB_STATS=n CONFIG_WLAN_CONV_SPECTRAL_ENABLE=n CONFIG_FEATURE_MEMDUMP_ENABLE=n CONFIG_FEATURE_UNIT_TEST_SUSPEND=n CONFIG_WLAN_WBUFF=n CONFIG_TSO_DEBUG_LOG_ENABLE=n CONFIG_WLAN_FEATURE_P2P_DEBUG=n CONFIG_DESC_DUP_DETECT_DEBUG=n CONFIG_DEBUG_RX_RING_BUFFER=n CONFIG_FOURTH_CONNECTION=n CONFIG_FOURTH_CONNECTION_AUTO=n CONFIG_REMOVE_PKT_LOG=y CONFIG_WDI_EVENT_ENABLE=n""
EXTRA_OEMAKE_append_sa415m = " WLAN_CFG_OVERRIDE="CONFIG_FEATURE_WLAN_STA_AP_MODE_DFS_DISABLE=n CONFIG_SUPPORT_P2P_BY_ONE_INTF_WLAN=y CONFIG_FEATURE_MONITOR_MODE_SUPPORT=n CONFIG_DCS=n CONFIG_WLAN_FEATURE_MIB_STATS=n CONFIG_WLAN_CONV_SPECTRAL_ENABLE=n CONFIG_FEATURE_MEMDUMP_ENABLE=n CONFIG_FEATURE_UNIT_TEST_SUSPEND=n CONFIG_WLAN_WBUFF=n CONFIG_TSO_DEBUG_LOG_ENABLE=n CONFIG_WLAN_FEATURE_P2P_DEBUG=n CONFIG_DESC_DUP_DETECT_DEBUG=n CONFIG_DEBUG_RX_RING_BUFFER=n CONFIG_FOURTH_CONNECTION=n CONFIG_FOURTH_CONNECTION_AUTO=n CONFIG_REMOVE_PKT_LOG=y CONFIG_WDI_EVENT_ENABLE=n""
